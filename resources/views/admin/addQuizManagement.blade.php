...
<div class="head-title mb-10">
    <div class="left">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a class="active" href="#">Add Lesson</a>
            </li>
        </ul>
    </div>
...
<div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
    <h2 class="text-lg font-bold mb-4 text-gray-900 dark:text-white">Create New Lesson</h2>
    <form action="{{ route('handle-add-lesson',$course->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        <div>
            <label for="lesson_title" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Lesson Title</label>
            <input type="text" id="lesson_title" name="lesson_title" placeholder="Enter lesson title"
        ...
        <div>
            ...
            <input type="text" id="lesson_description" name="lesson_description" placeholder="Enter lesson description"
                class="block w-full mt-1 px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
        </div>
        ...
        <div>
            <label for="lesson_thumbnail" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Lesson Thumbnail</label>
            <input type="file" id="lesson_thumbnail" name="lesson_thumbnail"
                class="block w-full mt-1 px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
        </div>

        <div class="flex justify-end gap-4">
            <a href="#" class="px-6 py-2 text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">Cancel</a>
            <button type="submit" class="px-6 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700">Save Lesson</button>
        </div>
    </form>
</div>
