...
<div class="head-title mb-10">
    <div class="left">
        <h1>{{ $course->title }} Quiz Management</h1>
        <ul class="breadcrumb">
            <li>
    ...
    <div class="flex space-x-4"> <!-- flex to align the buttons and space-x-4 to add spacing between buttons -->
        ...
        {{--  --}}
        <a href="{{ route('show-add-quiz-cms', $course->id) }}" class="btn-download flex items-center space-x-2">
...
<div class="flex flex-col gap-4">
    @if($quiz->isEmpty())
        <p class="text-gray-500">No quiz found for this course.</p>
    @else
        @foreach($quiz as $qz)
        <!-- Card 1 -->
        <div class="py-5  px-5 flex items-center w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-4 flex-1">
                <h5 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">{{ $qz->title }}</h5>
