...
<div class="navbar-menu relative z-50 hidden">
    ...
    <nav class="fixed top-0 right-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-l overflow-y-auto"> <!-- Mengubah 'left-0' menjadi 'right-0' dan 'border-r' menjadi 'border-l' -->
